...
public class TabPageIndicator extends LinearLayout {
     ...
     * 默认的Tab数量
     */
    public static final int COUNT_DEFAULT_TAB = 3;
    ...
    public TabPageIndicator(Context context, AttributeSet attrs) {
        ...
        mTabVisibleCount = a.getInt(R.styleable.TabPageIndicator_item_count, COUNT_DEFAULT_TAB);
        ...
        mPaint.setPathEffect(new CornerPathEffect(3)); //设置拐弯处平滑
    }
...
//                / 2;
        ...
        int rectWidth = getWidth() / mTabVisibleCount - 20;
        initRect(rectWidth);

        mInitTranslationX = getWidth() / mTabVisibleCount / 2 - rectWidth / 2;
    }

    private void initRect(int rectWidth) {
        mPath = new Path();
        mPath.moveTo(0, 0);
        mPath.lineTo(0, -20);
        mPath.lineTo(rectWidth, -20);
        mPath.lineTo(rectWidth, 0);
        mPath.close();
    }
